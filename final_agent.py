...
prompt = ChatPromptTemplate.from_messages([
    ...
    do not try to regenerate or optimize the cypher returned by the graphcyphertool please provide the cypher query in the output as well"""),
...
result = agent_executor.invoke({"input":"show me the schema"})
